...
quote = Quote.create([
						...
						{ quotes: "If money help a man to do good to others, it is of some value; but if not, it is simply a mass of evil, and the sooner it is got rid of, the better", author: "Swami Vivekananda", status: "approved" },
						...
						{ quotes: "If it’s a good idea, go ahead and do it. It’s much easier to apologize than it is to get permission", author: "Grace Hopper", status: "approved" },
